...
import com.smedialink.aigram.purchases.configuration.BillingConfiguration;
...
public class ApplicationLoader extends Application implements BillingProvider {
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/com.aigram.android/files");
    }
...
//
//        YandexMetricaConfig config = YandexMetricaConfig.newConfigBuilder(BuildVars.YANDEX_METRICA).build();
...
//        YandexMetrica.enableActivityAutoTracking(this);
    ...
    */
    ...
    private static void enableProxyIfNeeded() {
        if (MessagesController.getGlobalMainSettings().getBoolean("aigramProxyInstalled", false)) {
            return;
        }
        ...
        MessagesController.getGlobalMainSettings().edit().putBoolean("aigramProxyInstalled", true).commit();
    }
}
