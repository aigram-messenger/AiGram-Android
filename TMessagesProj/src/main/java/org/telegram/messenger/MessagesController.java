...
public class MessagesController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void updateConfig(final TLRPC.TL_config config) {
        AndroidUtilities.runOnUIThread(() -> {
           ...
           // maxPinnedDialogsCount = config.pinned_dialogs_count_max;//todo тут приходит число для пиннед чатов -> 5. Пока хардко 10
            maxPinnedDialogsCount = 10;//todo тут приходит число для пиннед чатов -> 5. Пока хардко 10
