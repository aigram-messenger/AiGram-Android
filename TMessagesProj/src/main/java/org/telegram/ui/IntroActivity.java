...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titles = new String[]{
                ...
                LocaleController.getInternalString(R.string.Page3Title),
        ...
        messages = new String[]{
                ...
                LocaleController.getInternalString(R.string.Page3Message),
        ...
        textView.setTextColor(0xff18BFB9);
